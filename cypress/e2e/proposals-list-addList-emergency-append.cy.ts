...
describe("Proposals", () => {
  describe("type action List Operation: append", () => {
    ...
    describe("Emergency proposal for type action: Append", () => {
      const input1 = "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0";
      const input2 = listAddress;
      const description = "Emergency Append to list";
      ...
      it("I should be able to CREATE a proposal to APPEND an address to a list", () => {
        ...
        cy.contains("Emergency Append to a list").should("exist");
        cy.contains("Emergency Append to a list").click({ force: true });
