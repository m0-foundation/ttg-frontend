// Generated by @wagmi/cli@0.1.15 on 11/30/2023 at 4:46:44 PM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export function writeStandardGovernor<TFunctionName extends string>(
  ...
  return writeContract({
    abi: standardGovernorABI,
    ...config,
  } as WriteContractArgs<typeof standardGovernorABI, TFunctionName>);
}
...
export function writeEmergencyGovernor<TFunctionName extends string>(
  ...
  return writeContract({
    abi: emergencyGovernorABI,
    ...config,
  } as WriteContractArgs<typeof emergencyGovernorABI, TFunctionName>);
}
...
export function writeZeroGovernor<TFunctionName extends string>(
  ...
  return writeContract({ abi: zeroGovernorABI, ...config } as WriteContractArgs<
    typeof zeroGovernorABI,
    TFunctionName
  >);
}
