// Generated by @wagmi/cli@0.1.15 on 7/19/2023 at 11:06:58 AM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export const iInflationaryVotesABI = [
  { type: "error", inputs: [], name: "AlreadyInitialized" },
  { type: "error", inputs: [], name: "CallerIsNotSPOG" },
...
export const ivoteABI = [
  ...
  },
  {
    ...
    type: "function",
    inputs: [
      { name: "resetSnapshotId", internalType: "uint256", type: "uint256" },
    ],
    name: "reset",
    outputs: [],
  },
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link iInflationaryVotesABI}__.
 */
export function getIInflationaryVotes(config: Omit<GetContractArgs, "abi">) {
  return getContract({ abi: iInflationaryVotesABI, ...config });
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link iInflationaryVotesABI}__.
 */
export function readIInflationaryVotes<
  TAbi extends readonly unknown[] = typeof iInflationaryVotesABI,
  TFunctionName extends string = string
>(config: Omit<ReadContractConfig<TAbi, TFunctionName>, "abi">) {
  return readContract({
    abi: iInflationaryVotesABI,
    ...config,
  } as unknown as ReadContractConfig<TAbi, TFunctionName>);
}

/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link iInflationaryVotesABI}__.
 */
export function writeIInflationaryVotes<TFunctionName extends string>(
  config:
    | Omit<
        WriteContractPreparedArgs<typeof iInflationaryVotesABI, TFunctionName>,
        "abi"
      >
    | Omit<
        WriteContractUnpreparedArgs<
          typeof iInflationaryVotesABI,
          TFunctionName
        >,
        "abi"
      >
  ...
  return writeContract({
    abi: iInflationaryVotesABI,
    ...config,
  } as WriteContractArgs<typeof iInflationaryVotesABI, TFunctionName>);
}

/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link iInflationaryVotesABI}__.
 */
export function prepareWriteIInflationaryVotes<
  TAbi extends readonly unknown[] = typeof iInflationaryVotesABI,
  TFunctionName extends string = string
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, "abi">) {
  return prepareWriteContract({
...
/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link iInflationaryVotesABI}__.
 */
export function watchIInflationaryVotesEvent<
  TAbi extends readonly unknown[] = typeof iInflationaryVotesABI,
  TEventName extends string = string
>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, "abi">,
  ...
  return watchContractEvent(
    { abi: iInflationaryVotesABI, ...config } as WatchContractEventConfig<
      TAbi,
      TEventName
    >,
    callback
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link ispogTokenABI}__.
 */
export function getIspogToken(config: Omit<GetContractArgs, "abi">) {
  return getContract({ abi: ispogTokenABI, ...config });
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link ispogTokenABI}__.
 */
export function readIspogToken<
  TAbi extends readonly unknown[] = typeof ispogTokenABI,
  TFunctionName extends string = string
>(config: Omit<ReadContractConfig<TAbi, TFunctionName>, "abi">) {
  return readContract({
    abi: ispogTokenABI,
...
/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link ispogTokenABI}__.
 */
export function writeIspogToken<TFunctionName extends string>(
  config:
    | Omit<
        WriteContractPreparedArgs<typeof ispogTokenABI, TFunctionName>,
        "abi"
      >
    | Omit<
        WriteContractUnpreparedArgs<typeof ispogTokenABI, TFunctionName>,
        "abi"
      >
) {
  return writeContract({ abi: ispogTokenABI, ...config } as WriteContractArgs<
    typeof ispogTokenABI,
    TFunctionName
  >);
}

/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link ispogTokenABI}__.
 */
export function prepareWriteIspogToken<
  TAbi extends readonly unknown[] = typeof ispogTokenABI,
  TFunctionName extends string = string
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, "abi">) {
  return prepareWriteContract({
...
/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link ispogTokenABI}__.
 */
export function watchIspogTokenEvent<
  TAbi extends readonly unknown[] = typeof ispogTokenABI,
  TEventName extends string = string
>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, "abi">,
  ...
  return watchContractEvent(
    { abi: ispogTokenABI, ...config } as WatchContractEventConfig<
      TAbi,
      TEventName
    >,
    callback
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link ivalueABI}__.
 */
export function getIvalue(config: Omit<GetContractArgs, "abi">) {
  return getContract({ abi: ivalueABI, ...config });
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link ivalueABI}__.
 */
export function readIvalue<
  TAbi extends readonly unknown[] = typeof ivalueABI,
  TFunctionName extends string = string
>(config: Omit<ReadContractConfig<TAbi, TFunctionName>, "abi">) {
  return readContract({
    abi: ivalueABI,
...
/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link ivalueABI}__.
 */
export function writeIvalue<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof ivalueABI, TFunctionName>, "abi">
    | Omit<WriteContractUnpreparedArgs<typeof ivalueABI, TFunctionName>, "abi">
) {
  return writeContract({ abi: ivalueABI, ...config } as WriteContractArgs<
    typeof ivalueABI,
    TFunctionName
  >);
}
...
/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link ivalueABI}__.
 */
export function prepareWriteIvalue<
  TAbi extends readonly unknown[] = typeof ivalueABI,
  TFunctionName extends string = string
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, "abi">) {
  return prepareWriteContract({
...
/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link ivalueABI}__.
 */
export function watchIvalueEvent<
  TAbi extends readonly unknown[] = typeof ivalueABI,
  TEventName extends string = string
>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, "abi">,
  ...
  return watchContractEvent(
    { abi: ivalueABI, ...config } as WatchContractEventConfig<TAbi, TEventName>,
    callback
  );
}

/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link ivoteABI}__.
 */
export function getIvote(config: Omit<GetContractArgs, "abi">) {
  return getContract({ abi: ivoteABI, ...config });
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link ivoteABI}__.
 */
export function readIvote<
  TAbi extends readonly unknown[] = typeof ivoteABI,
  TFunctionName extends string = string
>(config: Omit<ReadContractConfig<TAbi, TFunctionName>, "abi">) {
  return readContract({
    abi: ivoteABI,
...
/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link ivoteABI}__.
 */
export function writeIvote<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof ivoteABI, TFunctionName>, "abi">
    | Omit<WriteContractUnpreparedArgs<typeof ivoteABI, TFunctionName>, "abi">
) {
  return writeContract({ abi: ivoteABI, ...config } as WriteContractArgs<
    typeof ivoteABI,
    TFunctionName
  >);
}
...
/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link ivoteABI}__.
 */
export function prepareWriteIvote<
  TAbi extends readonly unknown[] = typeof ivoteABI,
  TFunctionName extends string = string
>(config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, "abi">) {
  return prepareWriteContract({
...
/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link ivoteABI}__.
 */
export function watchIvoteEvent<
  TAbi extends readonly unknown[] = typeof ivoteABI,
  TEventName extends string = string
>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, "abi">,
  ...
  return watchContractEvent(
    { abi: ivoteABI, ...config } as WatchContractEventConfig<TAbi, TEventName>,
    callback
  );
}
